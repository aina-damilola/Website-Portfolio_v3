...
function Projects(){
    return(
        <>
            {/* <Document icon = {folder} bg = "#323232" name = "Brain Tumor Detector" display = "flex" content = {<></>}/>  */}
            ...
            {/* <Document icon = {folder} bg = "#323232" name = "Mock Desktop OS" display = "flex" content = {<></>}/>  */}
            ...
            <Document icon = {folder} bg = "#323232" name = "NSBEHacks 2025" display = "flex" content = {<NSBE/>}/> 
            <Document icon = {folder} bg = "#323232" name = "UTSM Raven" display = "flex" content = {<></>}/> 
            {/* <Document icon = {folder} bg = "#323232" name = "Student Portfolio" display = "flex" content = {<></>}/>  */}
